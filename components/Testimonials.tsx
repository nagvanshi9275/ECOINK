    ...
    return (
        <section className="py-24 bg-gray-50/50 overflow-hidden">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                {/* Trust Footer */}
                <div className="mt-20 flex flex-wrap items-center justify-center gap-8 sm:gap-16 opacity-40 grayscale hover:grayscale-0 transition-all duration-500">
                    ...
                    <div className="text-gray-900 font-bold">10-Year Warranty</div>
                </div>
            </div>
        </section>
    );
