        ...
        <section className="py-24 bg-white">
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        >
                            <AccordionTrigger className="py-6 text-left text-lg font-semibold hover:no-underline group data-[state=open]:text-white">
                                <div className="flex items-start gap-4">
                                    <span className="flex-shrink-0 w-8 h-8 bg-amber-400 text-gray-900 rounded-lg flex items-center justify-center text-sm font-bold">
                                        {index + 1}
                                    </span>
                ...
                <div className="mt-16 bg-gradient-to-br from-gray-900 to-gray-800 rounded-2xl p-8 sm:p-12 text-center shadow-xl">
                    ...
                    <a
                        href="/contact"
                        className="inline-flex items-center bg-amber-400 hover:bg-amber-500 text-gray-900 font-bold px-8 py-4 rounded-xl shadow-lg hover:shadow-amber-400/25 transition-all duration-300"
                    >
                        Contact Us
                    </a>
                </div>
