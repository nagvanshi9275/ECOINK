...
import { ArrowRight, Check, Shield, Search, TrendingUp } from "lucide-react";
        ...
        <>
            ...
            <section className="relative h-screen min-h-[800px] flex items-center justify-center overflow-hidden">
                ...
                >
                    ...
                    >
                        Google Ads built to generate <span className="text-primary">booked jobs</span> — not junk leads
                    </motion.h1>
                    <motion.p
                        initial={{ opacity: 0, y: 20 }}
                        animate={{ opacity: 1, y: 0 }}
            ...
            {/* SECTION 3: MICRO PROBLEM VALIDATION */}
            <section className="py-20 bg-white/[0.02]">
                <div className="max-w-4xl mx-auto px-6 text-center">
                    <h2 className="text-3xl font-bold mb-4">Most Google Ads don't fail — <span className="text-red-400">they quietly leak money.</span></h2>
                    ...
                    <p className="text-primary font-medium">EcoInk Ads was built to stop the leaks — properly.</p>
                </div>
            </section>

            {/* HOW ECOINK ADS WORKS */}
            <section id="how-it-works" className="py-24">
                <div className="max-w-7xl mx-auto px-6">
                    <div className="text-center mb-16">
                        <h2 className="text-4xl font-bold mb-4">How EcoInk Ads turns search demand into booked jobs</h2>
                        <p className="text-gray-400 mb-12">Every EcoInk Ads campaign is built as a system — not just ads running in isolation.</p>

                        <div className="relative w-full h-[200px] md:h-[400px] mb-12">
                            <Image
                                src="/images/ads-three-steps.png"
                                alt="EcoInk Ads Process"
                                fill
