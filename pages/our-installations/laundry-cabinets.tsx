...
export default function LaundryCabinets({ service }: Props) {
    return (
        <>
            <Head>
                <title>{service?.name || "Laundry Cabinets Melbourne"} | Magri Cabinets</title>
                <meta
                    name="description"
                    content={service?.description || "Custom laundry cabinets by Melbourne's trusted cabinet makers. Efficient storage solutions, pull-out hampers, and folding stations. Free design consultation."}
                />
            ...
            <section className="relative bg-gradient-to-br from-gray-600 to-gray-700 pt-8 pb-16 lg:pt-36 lg:pb-24 overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
                    ...
                    <h1 className="text-3xl sm:text-5xl lg:text-6xl font-bold text-white leading-tight mb-6">
                        {service?.name || "Laundry Cabinets"}
                    </h1>
                    <p className="text-lg sm:text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed mb-8">
                        {service?.description || "Transform your laundry into an efficient, organized space with our custom-designed storage solutions."}
                    </p>
            ...
            <section id="contact-form" className="py-16 bg-gray-50">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <ServiceContactForm defaultService="Laundry Cabinets" />
                </div>
            </section>
...
export const getServerSideProps: import("next").GetServerSideProps = async () => {
    ...
    if (!service) {
        service = {
            ...
            description: "Transform your laundry into an efficient, organized space with our custom-designed storage solutions.",
            content: null
        };
    }
