...
export default function KitchenCabinets({ service }: Props) {
    return (
        <>
            <Head>
            ...
            <section className="relative bg-gradient-to-br from-gray-600 to-gray-700 pt-20 pb-16 lg:pt-28 lg:pb-24 overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
                    ...
                    <h1 className="text-3xl sm:text-5xl lg:text-6xl font-bold text-white leading-tight mb-6">
                        {service?.name || "Kitchen Cabinets"}
                    </h1>
                    <p className="text-lg sm:text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed mb-8">
                        {service?.description || "Create the heart of your home with stunning custom kitchen cabinetry, designed for your lifestyle and built to last a lifetime."}
                    </p>
            ...
            <section id="contact-form" className="py-16 bg-gray-50">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <ServiceContactForm defaultService="Kitchen Cabinets" />
                </div>
            </section>
...
export const getServerSideProps: import("next").GetServerSideProps = async () => {
    ...
    if (!service) {
        service = {
            ...
            description: "Create the heart of your home with stunning custom kitchen cabinetry, designed for your lifestyle and built to last a lifetime.",
            content: null
        };
    }
